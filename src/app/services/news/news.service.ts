...
*/
  ...
  export class NewsService {
    ...
    */
    ...
    // Get the list of news from a source
    public getNews( source: String, keyword: String = null): Promise<any> {
      return this.HttpClient.post(`${environment.apiUrl}/news/${source}/${keyword}`, { news_api_token: environment.apiKey }, this.setHeaderRequest())
      .toPromise()
    ...
    public addBookmark( data: any ): Promise<any> {
      return this.HttpClient.post(`${environment.apiUrl}/bookmark`, data, this.setHeaderRequest())
      .toPromise()
